...
<p>예를들어</p>
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>- 0ms 시점에 3ms가 소요되는 A작업 요청
...
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>- A: 3ms 시점에 작업 완료 (요청에서 종료까지 : 3ms)
